...
export function Activities({ tripDetails }: Props) {
  ...
  function resetNewACtivitiesFields() {
    setActivityDate('')
    setActivityTitle('')
    setActivityHour('')
    setModal(MODAL.NONE)
  ...
  async function handleCreateTripActivity() {
    try {
      ...
      Alert.alert('Nova atividade', 'Nova atividade cadastrada com sucesso!', [
        {
          text: 'OK',
          onPress: resetNewACtivitiesFields
        }
      ])
  ...
  return (
    <View className="flex-1">
      <View className="w-full flex-row mt-5 mb-6 items-center">
        ...
        <Button onPress={() => setModal(MODAL.NEW_ACTIVITY)}>
      ...
      <Modal
        ...
        visible={modal === MODAL.NEW_ACTIVITY}
      ...
      >
        <View className="mt-4 mb-3">
          ...
          <View className="w-full mt-2 mb-3 flex-row gap-2">
          ...
          <Button onPress={handleCreateTripActivity} isLoading={isLoading}>
